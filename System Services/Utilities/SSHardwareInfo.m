...
+ (NSString *)systemDeviceTypeFormatted:(BOOL)formatted {
    ...
    if (formatted) {
        ...
        @try {
            ...
            else if ([deviceType isEqualToString:@"Phone12,3"])
            ...
            // iPads
                ...
                newDeviceType = @"iPad 6th Gen (WiFi+Cellular)";
                ...
                newDeviceType = @"iPad Pro 3rd Gen (11 inch, WiFi)";
            else if ([deviceType isEqualToString:@"iPad8,2"])
                newDeviceType = @"iPad Pro 3rd Gen (11 inch, 1TB, WiFi)";
            else if ([deviceType isEqualToString:@"iPad8,3"])
                newDeviceType = @"iPad Pro 3rd Gen (11 inch, WiFi+Cellular)";
            else if ([deviceType isEqualToString:@"iPad8,4"])
                newDeviceType = @"iPad Pro 3rd Gen (11 inch, 1TB, WiFi+Cellular)";
            else if ([deviceType isEqualToString:@"iPad8,5"])
                newDeviceType = @"Pad Pro 3rd Gen (12.9 inch, WiFi)";
            else if ([deviceType isEqualToString:@"iPad8,6"])
                newDeviceType = @"iPad Pro 3rd Gen (12.9 inch, 1TB, WiFi)";
            else if ([deviceType isEqualToString:@"iPad8,7"])
                newDeviceType = @"iPad Pro 3rd Gen (12.9 inch, WiFi+Cellular)";
            else if ([deviceType isEqualToString:@"iPad8,8"])
                newDeviceType = @"iPad Pro 3rd Gen (12.9 inch, 1TB, WiFi+Cellular)";
                ...
                newDeviceType = @"iPad Air 3rd Gen";
            // Catch All iPad
